...
var TRANSLATIONS = {
  ...
  fr: {
    ...
    actions: "Actions",
    show_dropdown: "Afficher la liste d\xE9roulante"
  },
  es: {
    ...
    actions: "Acciones",
    show_dropdown: "Mostrar men\xFA desplegable"
  },
  de: {
...
var CustomRoomCard = class extends HTMLElement {
  ...
  _room(room, ids, roomIndex) {
    ...
    const tempValue = temp ? formatState(temp, "\xB0C", 1) : null;
    ...
    const customMetrics = (room.summary_entities || []).map((item) => {
...
var CustomRoomCardEditor = class extends HTMLElement {
  ...
  _updateSummaryEntity(roomIndex, entityIndex, changes) {
    ...
    const item = typeof summary_entities[entityIndex] === "string" ? { entity: summary_entities[entityIndex] } : { ...summary_entities[entityIndex] };
